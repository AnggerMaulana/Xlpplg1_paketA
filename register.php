                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="no_telepon" required class="form-control" name="username" placeholder="username..." />
                        </div>
                        <div class="form-group">
                            <label class="form-label">Password</label>
                            <input type="nama" required class="form-control" name="password" placeholder="password..." />
                        </div>
                        <div class="form-group">
                            <label class="form-label">Level</label>
                            <input type="nama" required class="form-control" name="level" placeholder="level..." />
                        </div>
                        </div>
                        <div class="form-group">
